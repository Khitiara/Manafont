    ...
    public partial class Setup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManafontGameSession", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ManafontGameSession_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ManafontGameSession_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManafontGameSession_CharacterId",
                table: "ManafontGameSession",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_ManafontGameSession_UserId",
                table: "ManafontGameSession",
                column: "UserId");
